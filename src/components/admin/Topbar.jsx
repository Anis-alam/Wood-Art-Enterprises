...
import { Bell, UserCircle, X, LogOut } from "lucide-react";
...
export default function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-30 h-20 bg-white shadow px-4 md:px-8 flex items-center justify-between">
      {/* Left */}
      <div>
